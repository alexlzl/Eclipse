 ...
 * @author:LiuZhouLiang
 * 
 * @time:2015-3-14下午5:17:27
 * 
 */
public class FinishOrder extends BaseActivity implements OnItemClickListener,
		OnMoreListener, OnRefreshListener, OrderListStateChange {
	private static final String TAG = "FinishOrder";
	...
	protected void onCreate() {
		...
		setBaseContentView(R.layout.finish_order);
	...
	protected void loadChildView() {
		// TODO Auto-generated method stub
		listview = (MsRefreshListView) findViewById(R.id.finish_order_lv);
	}
	...
	protected void getNetData() {
		...
		map.put("queryType", MsConfiguration.FINISH_ORDER_LIST);
		map.put("outerType", 2);
		if (pageNum == 0) {
			/**
			 * 加载第一页
	...
	protected void reloadCallback() {
		// TODO Auto-generated method stub
		setReloadContent(R.layout.finish_order);
		getNetData();
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		intent.putExtra(MsConfiguration.PAGE_TYPE_KEY,
				MsConfiguration.PAGE_TYPE_DETAIL);
		...
		if (pageNum == 0) {
			...
			if (orderEntity != null && orderEntity.getCode() == 0) {
				...
				if (orderEntity.getInfo() != null
					...
					adapter = new FinishOrderAdapter(baseContext, orderList);
