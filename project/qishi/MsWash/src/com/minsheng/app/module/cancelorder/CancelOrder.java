 ...
 * 
 */
public class CancelOrder extends BaseActivity implements OnMoreListener,
		OnRefreshListener, OrderListStateChange {
	...
	protected void onCreate() {
		...
		setBaseContentView(R.layout.cancel_order_list);
	}
	...
	protected void loadChildView() {
		// TODO Auto-generated method stub
		listview = (MsRefreshListView) findViewById(R.id.cancel_order_list_lv);
	}
	...
	protected void getNetData() {
		...
		map.put("queryType", MsConfiguration.CANCEL_ORDER_LIST);
		map.put("outerType", 2);
		if (pageNum == 0) {
			/**
			 * 加载第一页
		...
		if (pageNum == 0) {
			...
			if (orderEntity != null && orderEntity.getCode() == 0) {
				...
				if (orderEntity.getInfo() != null
					...
					adapter = new CancelOrderAdapter(baseContext, orderList);
