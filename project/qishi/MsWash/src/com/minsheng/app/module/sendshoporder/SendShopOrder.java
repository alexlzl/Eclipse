 ...
 * @author:LiuZhouLiang
 * 
 * @time:2015-3-14下午1:46:33
 * 
 */
public class SendShopOrder extends BaseActivity implements OnItemClickListener,
		OnMoreListener, OnRefreshListener, OrderListStateChange {
	private static final String TAG = "SendShopOrder";
	private MsRefreshListView listview;
	private SendShopOrderAdapter adapter;
	...
	protected void onCreate() {
		...
		setBaseContentView(R.layout.send_shop_order);
	}
	...
	protected void loadChildView() {
		// TODO Auto-generated method stub
		listview = (MsRefreshListView) findViewById(R.id.send_shop_order_lv);
	}
	...
	protected void getNetData() {
		...
		map.put("queryType", MsConfiguration.SEND_SHOP_LIST);
		map.put("outerType", 2);
		if (pageNum == 0) {
			/**
			 * 加载第一页
	...
	protected void reloadCallback() {
		// TODO Auto-generated method stub
		setReloadContent(R.layout.send_shop_order);
		getNetData();
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		intent.putExtra(MsConfiguration.ORDER_TYPE,
				MsConfiguration.SEND_SHOP_ORDER);
		...
		LogUtil.d(TAG, "ORDERID" + orderList.get(arg2 - 1).getOrderId());
		...
		if (pageNum == 0) {
			...
			if (orderEntity != null && orderEntity.getCode() == 0) {
				...
				if (orderEntity.getInfo() != null
					...
					adapter = new SendShopOrderAdapter(baseContext, orderList);
