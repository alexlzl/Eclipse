...
import com.minsheng.app.module.sendclothesbackorder.SendClothesBackOrderAdapter.OrderChangeListener;
 ...
 * @author:LiuZhouLiang
 * 
 * @time:2015-3-14下午4:43:46
 * 
 */
public class SendClothesBackOrder extends BaseActivity implements
		OnItemClickListener, OnMoreListener, OnRefreshListener,
		OrderChangeListener, OrderListStateChange {
	private static String TAG = "SendClothesBackOrder";
	private MsRefreshListView listview;
	private SendClothesBackOrderAdapter adapter;
	...
	protected void onCreate() {
		...
		setBaseContentView(R.layout.sendclothesback_order);
	}
	...
	protected void loadChildView() {
		// TODO Auto-generated method stub
		listview = (MsRefreshListView) findViewById(R.id.sendclothesback_order_lv);
	}
	...
	protected void getNetData() {
		...
		map.put("queryType", MsConfiguration.SEND_CLOTHES_LIST);
		map.put("outerType", 2);
		if (pageNum == 0) {
			/**
			 * 加载第一页
	...
	protected void reloadCallback() {
		// TODO Auto-generated method stub
		setReloadContent(R.layout.sendclothesback_order);
		getNetData();
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
		LogUtil.d(TAG, adapter.orderType.toString());
		...
		if (pageNum == 0) {
			...
			if (orderEntity != null && orderEntity.getCode() == 0) {
				...
				if (orderEntity.getInfo() != null
					...
					adapter = new SendClothesBackOrderAdapter(baseContext,
							orderList);
