 ...
 * @author:LiuZhouLiang
 * 
 * @time:2015-3-14下午4:20:57
 * 
 */
public class GetClothesOrder extends BaseActivity implements
		OnItemClickListener, OnMoreListener, OnRefreshListener,
		OrderListStateChange {
	private static final String TAG = "AppointmentOrder";
	private MsRefreshListView listview;
	private GetClothesOrderAdaper adapter;
	...
	protected void onCreate() {
		...
		setBaseContentView(R.layout.getclothes_order);
	}
	...
	protected void loadChildView() {
		// TODO Auto-generated method stub
		listview = (MsRefreshListView) findViewById(R.id.getclothes_lv);
	}
	...
	protected void getNetData() {
		...
		map.put("queryType", MsConfiguration.GET_CLOTHES_LIST);
		map.put("outerType", 2);
		if (pageNum == 0) {
			/**
			 * 加载第一页
	...
	protected void reloadCallback() {
		// TODO Auto-generated method stub
		setReloadContent(R.layout.getclothes_order);
		getNetData();
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		intent.putExtra(MsConfiguration.ORDER_TYPE,
				MsConfiguration.GET_CLOTHES_BACK);
		...
		if (pageNum == 0) {
			...
			if (orderEntity != null && orderEntity.getCode() == 0) {
				...
				if (orderEntity.getInfo() != null
					...
					adapter = new GetClothesOrderAdaper(baseContext, orderList);
