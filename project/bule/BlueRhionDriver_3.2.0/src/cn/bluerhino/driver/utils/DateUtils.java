...
public class DateUtils {
	...
	public String getDates(long time) {
		// Date date = new Date();
		...
		jintian = DateUtils.getDate4PHP(times);
		// SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

		long mingtian = DateUtils.getDate4PHP(DateUtils
				.getDateTime4PHPByNum(+1));
		long houtian = DateUtils
				.getDate4PHP(DateUtils.getDateTime4PHPByNum(+2));
		;
		long dahoutian = DateUtils.getDate4PHP(DateUtils
